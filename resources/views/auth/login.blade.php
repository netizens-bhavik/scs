                        ...
                        <form method="POST" class="mb-3" action="{{ route('login') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" id="email" type="email" name="email"
                                    :value="old('email')" required placeholder="Enter Your Email Address" autofocus />
                            </div>
                            ...
                            <div class="mb-3">
                                <button class="btn btn-primary d-grid w-100" type="submit" title="Submit">Sign in</button>
                            </div>
                        </form>
                    </div>
                </div>
