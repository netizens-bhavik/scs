...
<head>
    ...
    <title>SoftCallingSystem - Login</title>
                ...
                <div class="card-body">
                    ...
                    <div class="app-brand justify-content-center">
                        <a href="{{ url('/') }}" class="app-brand-link gap-2">
                            ...
                            {{-- <span class="app-brand-text demo text-body fw-bolder text-uppercase">SoftCall</span> --}}
                        </a>
                    </div>
                    <!-- /Logo -->
                    {{-- <h4 class="mb-2">Welcome to SoftCall! 👋</h4>
                    ...
                    <form method="POST" class="mb-3" action="{{ route('password.update') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" id="email" type="email" name="email"
                                   value="{{$request->email}}" required placeholder="Enter Your Email Address" autofocus  readonly/>
                        </div>
                        ...
                        <div class="mb-3">
                            <button class="btn btn-primary d-grid w-100" type="submit" title="Reset Password">Reset Password</button>
                        </div>
                    </form>
                </div>
            </div>
