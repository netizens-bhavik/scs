                ...
                <div class="card">
                    <div class="card-header">
                        <div class="main-heading">
                            <h4 class="header-title">INCOMING DASHBOARD</h4>
                            <a href="{{ url('/incoming_dashboard') }}"><span class="h5 text-primary">GO BACK</span></a>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-xl-4 col-xxl-5">
                                        ...
                                        <div class="col-sm-6 col-md-4 col-xl-6 col-xxl-4 mb-2">
                                            <div class="app-card">
                                                <div class="content">
                                                    ...
                                                    <h6 class="text-primary h6"> {{ $last_call_date ?? 'N/A' }} </h6>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6 col-md-4 col-xl-6 col-xxl-4 mb-2">
                                ...
                                <form action="javascript:void(0);" id="soft_calling_incoming_frm" method="POST"
                                        ...
                                        <div class="col-md-12 mt-3" id="called_details" style="display: none">
                                            ...
                                            <div class="row mt-3">
                                                ...
                                                <div class="col-sm-6 col-xl-12 col-xxl-6 mt-3 mt-sm-0">
                                                    <span class="text-danger">*</span>
                                                    <label for="email_id" class="mb-2">Do you have any manpower
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <h3 class="text-secondary">Incoming Dashboard</h3>
...
@section('scripts')
    <script>
        ...
        $('#soft_calling_incoming_frm').submit(function(e) {
            ...
            if (call_status == 3) {
                ...
                // var cell_no = $('#cell_no').val();
                // if (cell_no == '') {
                //     $('#cn_error_message').html('Please enter cell no');
                // }
                ...
                success: function(response) {
                    if (response.status == true) {
                        ...
                        swal({
                            ...
                            window.location.href = "{{ url('incoming_dashboard') }}";
                        });
                    } else {
                        swal.close();
                        swal({
