            ...
            <tr>
                <td align="center" valign="top" id="bodyCell">
                    ...
                    <table bgcolor="#FFFFFF" border="0" cellpadding="0" cellspacing="0" width="600"
                        ...
                        <tr>
                            <td align="center" valign="top" bgcolor="#ed2024">
                                            ...
                                            <table border="0" cellpadding="30" cellspacing="0" width="100%">
                                                <tr>
                                                    <td align="center" valign="top" class="textContent"
                                                        style="padding: 20px">
                                                        <h1
                                                            style="color:#FFFFFF;line-height:100%;font-family:Helvetica,Arial,sans-serif;font-size:28px;font-weight:normal;margin-bottom:15px;text-align:center;">
                                                            New Alpha Soft Calling System </h1>
                                                        <div
                                                            style="text-align:center;font-family:Helvetica,Arial,sans-serif;font-size:20px;font-weight: bold;margin-bottom:0;color:#FFFFFF;line-height:135%;">
                                                            {{ $subject }}</div>
                                                    </td>
                                                </tr>
                                            </table>
                        ...
                        <tr>
                            <td align="center" valign="top">
                                <table border="0" width="600" class="flexibleContainerCell" cellpadding="20"
                                    cellspacing="0">
                                    <tr>
                                        <td>
                                            {{ $mail_message }}
                                                ...
                                                <tr>
                                                    <td align="center" valign="top">
                                                        <table border="0" cellpadding="0" cellspacing="0"
                                                            ...
                                                            style="background-color: #ed2024;">
                                                            <tr>
                                                                <td align="center" valign="middle"
                                                                    class="buttonContent" style="padding: 0;">
                                                                    <a style="color:#FFFFFF;text-decoration:none;font-family:Helvetica,Arial,sans-serif;font-size:20px;line-height:135%;padding-top:15px;padding-bottom:15px;padding-right:15px;padding-left:15px;"
                                                                        href="#"
